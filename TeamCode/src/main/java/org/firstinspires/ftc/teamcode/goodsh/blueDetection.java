...
public class blueDetection implements VisionProcessor {
    ...
    public blueDetection(Telemetry telemetry) {this.telemetry = telemetry;}
    ...
    public Object processFrame(Mat frame, long captureTimeNanos) {
        ...
        Imgproc.rectangle(mat, LEFT_ROI, readout == 1? Green:Red);
        Imgproc.rectangle(mat, CENTER_ROI, readout == 2? Green:Red);
        Imgproc.rectangle(mat, RIGHT_ROI, readout == 3? Green:Red);
